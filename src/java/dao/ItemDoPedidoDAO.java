...
public class ItemDoPedidoDAO {
    private final String insertItemPedido = "INSERT INTO item_do_pedido (id_pedido, id_produto, qtdade) VALUES (?, ?, ?);";
    private final String selectItemPedido = "SELECT (id_pedido, id_produto, qtdade) FROM item_do_pedido WHERE id = ? ";
    private final String updateItemPedido = "UPDATE item_do_pedido set nome = ?, sobrenome = ?, cpf = ? WHERE id = ?";
    private final String deleteItensPedido = "DELETE FROM item_do_pedido WHERE id_pedido = ?;";
    private final String selectListaItemPedido = "SELECT id, nome, sobrenome, cpf FROM item_do_pedido;";
